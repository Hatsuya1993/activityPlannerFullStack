...
const RowComponents : React.FC<RowComponentsType> = ({googleSearchMap}) => {
    ...
    return (
        <div className='w-5/6 h-[200px] mx-auto flex items-center scroll-smooth overflow-x-scroll gap-3 scrollbar-thumb-gray-100 scrollbar-track-transparent scrollbar-thin'>
